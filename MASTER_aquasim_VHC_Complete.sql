-- =============================================
-- aquasim_VHC Database - MASTER COMPLETE SQL Script
-- Version: 3.0 Final (Master Edition)
-- Date: 2025-11-15
-- Description: Complete database schema for aquasim_VHC system
--              Gộp tất cả các file SQL thành một file duy nhất
-- =============================================
--
-- HƯỚNG DẪN SỬ DỤNG:
-- 1. Mở SQL Server Management Studio (SSMS)
-- 2. Connect vào SQL Server instance
-- 3. Mở file này và Execute (F5)
-- 4. Database sẽ được tạo hoàn chỉnh từ đầu
--
-- LƯU Ý:
-- - Script này sẽ DROP database hiện có (nếu tồn tại)
-- - Tất cả dữ liệu cũ sẽ bị xóa
...
VALUES
    ('PROB01', N'Men vi sinh', 'PROBIOTIC', N'Cải thiện môi trường nước', 'kg', 0.5, 50000, 1),
    ('VITC01', N'Vitamin C', 'VITAMIN', N'Tăng cường sức đề kháng', 'kg', 0.2, 80000, 1),
    ('LIME01', N'Vôi bột', 'pH_ADJUSTER', N'Điều chỉnh pH', 'kg', 10.0, 5000, 1);
GO
